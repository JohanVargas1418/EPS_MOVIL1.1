...
  const [nombre, setNombre] = useState(""); // Inicializar con cadena vacía
  const [descripcion, setDescripcion] = useState(""); // Inicializar con cadena vacía
...
          <Text style={styles.subtitle}>Detalles de la especialidad médica</Text> {/* Subtítulo */}
        </View>

        <ScrollView contentContainerStyle={styles.scrollContent}>
          <View style={styles.formContainer}>
            <Text style={styles.formTitle}>Formulario de Especialidad</Text>
