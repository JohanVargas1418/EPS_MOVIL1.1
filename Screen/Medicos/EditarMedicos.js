...
// Simulación de un servicio para obtener especialidades desde la base de datos
// En una aplicación real, esto sería una llamada a tu API o base de datos.
...
export default function EditarMedicosScreen() {
  ...
  const [loading, setLoading] = useState(false);  // Estado para controlar el loading general
  const [loadingEspecialidades, setLoadingEspecialidades] = useState(true); // Estado para controlar el loading de especialidades
  ...
  useEffect(() => {
    const fetchEspecialidades = async () => {
      try {
        const data = await getEspecialidades(); // Llama a la función simulada o real de tu servicio
        setEspecialidades(data);
        // Si estamos editando y el médico ya tiene una especialidad, la seleccionamos
        if (medicos?.idEspecialidad) {
          setIdEspecialidad(medicos.idEspecialidad.toString());
        }
      } catch (error) {
            ...
            <View style={styles.pickerContainer}>
              {loadingEspecialidades ? (
                ...
                <Picker
                  ...
                  style={styles.picker} 
                >
                  <Picker.Item label="Seleccione una especialidad" value={idEspecialidad} />
